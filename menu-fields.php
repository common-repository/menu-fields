...
if ( ! class_exists( 'MenuFields' ) ) {
	...
	class MenuFields {
		...
		function __construct() {
			...
			add_action( 'wp_nav_menu_item_custom_fields',	array( $this, 'menu_fields_custom_filds' ), 10, 4  );
		...
		function menu_fields_custom_filds($item_id, $item, $depth, $args){
            include('walker_fields.php');
        }
		...
		static function menu_fields_meta_name( $field ){
